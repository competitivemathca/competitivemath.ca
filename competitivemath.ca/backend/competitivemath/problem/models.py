...
class Problem(models.Model):
    ...
    # Can be no tags
    tags = models.ManyToManyField('problem.Tag', blank=True, related_name='tag_of_these_problems')
    ...
    # Must explicitly set this attribute after contest has been published
    date_time_published = models.DateTimeField(blank=True)
    # ---------- POST CONTEST PROBLEM SETTINGS ---------- #
