...
export default function Problems() {
  ...
  return (
    <div className="xl:w-8/12 border-[2px] border-solid border-blue-800 rounded-2xl">
      <TablePanel>
      {/*Might need to put the table heading in a separate component for style reuse*/}
        <thead>
          <tr>
            <th title="Problem ID" className="hover:cursor-default">#</th>
            <th title="Problem Name" className="hover:cursor-default">Problem Name</th>
            <th title="Tags" className="hover:cursor-default">Tags</th>
            <th title="Competitive Rating" className="hover:cursor-default">CR</th>
            <th title="Completed Submissions" className="hover:cursor-default">👥</th>
          </tr>
        </thead>
        <tbody>
          <ProblemComponent
